    ...
    .clickButton:active {
        ...
        box-shadow: 0 2px 2px rgba(0, 0, 0, 0.25);
            ...
            <div style="display: flex;align-items: center;justify-content: space-between;border-radius: 0.5rem;border:1px solid rgb(0,0,0,0.3);padding: 2rem;margin-bottom: 1.5rem;">
                ...
                <div onclick="window.open('${this.link}','_blank')" class="clickButton" style="width: max-content;white-space: nowrap;padding: 0.5rem 1rem;color: white;background-color: #3ca0e6;border-radius: 0.3rem;cursor: pointer;">
                View Issue
                </div>
            </div>
        `
